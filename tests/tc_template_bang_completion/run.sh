...
# ../../bin/dcd-client $1 file.d -c529 > actual9.txt
# diff actual9.txt expected9.txt --strip-trailing-cr

# ../../bin/dcd-client $1 file.d -c580 > actual10.txt
# diff actual10.txt expected10.txt --strip-trailing-cr

# ../../bin/dcd-client $1 file.d -c586 > actual11.txt
# diff actual11.txt expected11.txt --strip-trailing-cr

../../bin/dcd-client $1 file.d -c638 > actual12.txt
diff actual12.txt expected12.txt --strip-trailing-cr
